...
def sw_bted(tree_a: CapstoneNode, tree_b: CapstoneNode, cost_model: SWCostModel, k: Optional[float] = None) -> dict:
    """
    Tính khoảng cách SW-BTED và phân rã kết quả theo từng section.
    k: Bounded threshold (tỉ lệ tối đa max_edit_budget_ratio * max_possible_cost)
    """
